<template>
  <el-dialog title="编辑转发文章到第三方平台" :visible.sync="dialogTableVisible">
    <el-form ref="ruleForm" labelPosition="left" :model="form" labelWidth="80px">
      <el-row>
        <el-form-item labelWidth="180" label="成功转发一篇文章，可以获得积分">
          <el-col :span="3">
      ...
      <el-row>
        <el-form-item labelWidth="180" label="每日上限">
          <el-col :span="20">
            <el-radio-group style="float:left; line-height:50px;margin-left: 85px" v-model="radioValue2" @change="radioChange2">
...
import Score, {TASK_DETAIL_URL, TASK_ARTICLE_SHARE_URL} from '@/api/platform/score/score'
